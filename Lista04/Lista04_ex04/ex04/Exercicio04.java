    ...
    public static void main(String[] args) {
        ...
        while (selectedItem != "Sair") {
            switch (selectedItem) {
                ...
                case "Inserir Aluno":
                    Object[] subItens = {"Aluno de Graduação", "Aluno de Pós Graduação", "Voltar"};
                    ...
                    while (!subSelectedItem.equals("Voltar")) {
                        if (subSelectedItem.equals("Aluno de Graduação")) {
                            String ra = JOptionPane.showInputDialog("Digite o ra do aluno(a)");
                            ...
                            AlunoGrad newalunograd = new AlunoGrad(ra, nome, curso, anoc);
                            ...
                            AlunoPos newalunopos = new AlunoPos(ralun, nomeal, cursoal, anoc);
